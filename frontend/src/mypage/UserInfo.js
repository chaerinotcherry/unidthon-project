...
function UserInfo() {
  ...
  return (
    <div
      ...
      style={{ backgroundColor: "#F6F6F6", width: "900px" }}
    >
        ...
        <div className="row mb-3">
          ...
          <div className="col-4 d-flex align-items-center">
            <input
              ...
              checked={formData.haveHouse === true}
          ...
          <div className="col-4 d-flex align-items-center">
            <input
              ...
              value={false}
              onChange={handleChange}
              checked={formData.haveHouse === false}
              style={{ marginRight: "3px" }}
            />{" "}
            아니오
          </div>
        ...
        <div className="row mb-3">
          ...
          <div className="col-4 d-flex align-items-center">
            <input
              ...
              value={true}
              onChange={handleChange}
              checked={formData.haveWorked === true}
              style={{ marginRight: "3px" }}
            />{" "}
            예
          </div>
          <div className="col-4 d-flex align-items-center">
            <input
              ...
              value={false}
              onChange={handleChange}
              checked={formData.haveWorked === false}
              style={{ marginRight: "3px" }}
            />{" "}
            아니오
          </div>
        ...
        {/* <div className="row mb-3">
          ...
          >
            <input
              ...
              value="0~ 3683만원"
              onChange={handleChange}
              checked={formData.carPrice === "0~ 3683만원"}
              style={{ marginRight: "3px" }}
            />{" "}
            0~3683만원
          </div>
          ...
          >
            <input
              ...
              value="3683 ~ 3708만원"
              onChange={handleChange}
              checked={formData.carPrice === "3683 ~ 3708만원"}
              style={{ marginRight: "3px" }}
            />{" "}
            3683~3708만원
          </div>
          ...
          >
            <input
              ...
              value="3708만원 이상"
              onChange={handleChange}
              checked={formData.carPrice === "3708만원 이상"}
              style={{ marginRight: "3px" }}
            />{" "}
            3708만원 이상
          </div>
